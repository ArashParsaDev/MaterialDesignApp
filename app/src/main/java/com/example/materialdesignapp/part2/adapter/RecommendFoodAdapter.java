...
public class RecommendFoodAdapter extends RecyclerView.Adapter<RecommendFoodAdapter.MyViewHolder> {
    Context context;
    List<Food> data;

    public RecommendFoodAdapter(Context context, List<Food> data) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_food_recommend,parent,false);
